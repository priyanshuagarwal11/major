        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10 bg-slate-950/15">
          ...
          >
            ...
            <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
              ...
              {/* Header Title */}
              <div className="mb-6">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-bold text-sky-400 bg-sky-500/10 rounded-full border border-sky-500/10 uppercase tracking-widest">
                  Secure Access
                </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5 text-left">
                  <div className="flex justify-between items-center">
                    ...
                    <a href="#forgot" className="text-xs text-sky-400 hover:text-sky-300 font-medium transition-colors">
                      Forgot Password?
                    </a>
                  </div>
                  <div className="relative">
                ...
                >
                  {isFormSubmitting || isAuthLoading ? (
                    ...
                    <div className="flex items-center gap-1.5">
                      <span>Access Placement Hub</span>
