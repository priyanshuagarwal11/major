...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Github, Chrome, Sparkles, AlertCircle } from 'lucide-react';
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span className="status-badge primary" style={{ gap: '6px' }}>
                  <Sparkles size={12} /> Live Scoring Simulation
                </span>
                <span
                  style={{
                    width: '10px',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                <div>
                  ...
                  >
                    ...
                    <strong style={{ color: 'var(--text)' }}>92%</strong>
                  </div>
                  <div
                    style={{
                      width: '100%',
                ...
                <div>
                  ...
                  >
                    ...
                    <strong style={{ color: 'var(--text)' }}>86%</strong>
                  </div>
                  <div
                    style={{
                      width: '100%',
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', marginTop: '4px' }}>
                      ATS score optimized. Recommend adding bullet points on distributed caching.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div style={{ marginTop: '32px' }}>
              ...
              >
                Connect resumes, mock interviews, coding practice, and job tracking under a
                unified dashboard designed for candidate placement.
              </p>
            </div>
          </motion.div>

          <div style={{ color: 'var(--text-muted)', fontSize: '0.78rem' }}>
            Powered by next-gen RAG and agent coordination services.
          </div>
        </div>
          ...
          >
            ...
            >
              <div style={{ marginBottom: '24px' }}>
                <span className="status-badge primary">Secure Access</span>
                <h1
                  style={{
                    marginTop: '14px',
                    fontSize: '1.85rem',
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '6px' }}>
                  Authenticate your workspace to resume interview drills and score updates.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  >
                    ...
                    <a
                      href="#forgot"
                      style={{ color: 'var(--primary)', fontSize: '0.82rem', fontWeight: 800 }}
                    >
                      Forgot Password?
                    </a>
                  </div>
              ...
              >
                New candidate?{' '}
                <Link to="/signup" style={{ color: 'var(--primary)', fontWeight: 900 }}>
